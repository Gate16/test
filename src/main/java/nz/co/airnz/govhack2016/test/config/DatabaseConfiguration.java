...
import nz.co.airnz.govhack2016.test.config.liquibase.AsyncSpringLiquibase;
...
@Configuration
@EnableJpaRepositories("nz.co.airnz.govhack2016.test.repository")
@EnableJpaAuditing(auditorAwareRef = "springSecurityAuditorAware")
@EnableTransactionManagement
@EnableElasticsearchRepositories("nz.co.airnz.govhack2016.test.repository.search")
